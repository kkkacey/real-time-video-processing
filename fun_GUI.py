...
#    Canvas  = Tk.Label(top, image = None) 
    ...
    S_light  = Tk.Scale(top, variable = light_shift, from_ = 0, to = 10)
    S_color  = Tk.Scale(top, variable = color_shift, from_ = -20, to = 20)
    S_HSL    = Tk.Scale(top, variable = HSL_shift, from_ = -10, to = 10)
